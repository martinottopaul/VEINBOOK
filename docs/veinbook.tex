...
\tightlist
\item
  ``VOC\_gkm'', ``CO\_gkm'', ``NOx\_gkm'', ``PM\_gkm'', ``Pb\_gkm'',
  ``SO2\_gkm'', ``NH3\_gkm'', ``ONE\_3\_butadiene\_gkm'',
  ``formaldehyde\_gkm'', ``acetaldehyde\_gkm'', ``benzene\_gkm'',
  ``EVAP\_gkm'', ``CO2\_gkm'', ``N20\_gkm'', ``CH4\_gkm''
\item
  ``VOC\_gstart'', ``CO\_gstart'', ``NOx\_gstart'', ``PM\_gstart'',
  ``Pb\_gstart'', ``SO2\_gstart'', ``NH3\_gstart'',
  ``ONE\_3butadiene\_gstart'',
...
CETESB emission factors for 2016 \citep{CETESB2016}, covering the
following list of pollutants:

\begin{itemize}
\tightlist
\item
  ``COd'', ``HCd'', ``NMHCd'', ``CH4'', ``NOxd'', ``CO2'' ``PM'',
  ``N2O'', ``KML'', ``FC'', ``NO2d'', ``NOd'', ``gCO2/KWH'', ``RCHOd'',
...
\tightlist
\item
  ``PC\_G'', ``PC\_FG'', ``PC\_FE'', ``PC\_E'' ``LCV\_G'', ``LCV\_FG'',
  ``LCV\_FE'', ``LCV\_E'', ``LCV\_D'', ``SLT'', ``LT'', ``MT'', ``SHT''
  ``HT'', ``UB'', ``SUB'', ``COACH'', ``ARTIC'', ``M\_G\_150'',
...
In my case, the files are in directory /tmp/RtmpJQp9lK/YourCity. Now, if
...
## 1 0.001448040 [g/m^2/s] 0.01171596 0.0004645010 0.001980241 0.01880571
## 2 0.001439303 [g/m^2/s] 0.01164527 0.0004616984 0.001968293 0.01869224
