...
\begin{verbatim}
## files at /tmp/Rtmpm9wSQ0/YourCity
\end{verbatim}
...
## [17] "/tmp/Rtmpm9wSQ0/YourCity/veh"
\end{verbatim}

In my case, the files are in directory /tmp/Rtmpm9wSQ0/YourCity. Now, if
...
\caption{\label{tab:unnamed-chunk-86}Ratio between break and tire wear emissions}
\centering
\begin{tabular}[t]{l|r}
\hline
  & x\\
