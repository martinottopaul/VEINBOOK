...
\begin{verbatim}
## files at /tmp/RtmpUEeCGB/YourCity
\end{verbatim}

\begin{verbatim}
## Directories:
##  [1] "/tmp/RtmpUEeCGB/YourCity"             
##  [2] "/tmp/RtmpUEeCGB/YourCity/ef"          
##  [3] "/tmp/RtmpUEeCGB/YourCity/emi"         
##  [4] "/tmp/RtmpUEeCGB/YourCity/emi/BUS_01"  
##  [5] "/tmp/RtmpUEeCGB/YourCity/emi/HGV_01"  
##  [6] "/tmp/RtmpUEeCGB/YourCity/emi/LCV_01"  
##  [7] "/tmp/RtmpUEeCGB/YourCity/emi/MC_01"   
##  [8] "/tmp/RtmpUEeCGB/YourCity/emi/PC_01"   
##  [9] "/tmp/RtmpUEeCGB/YourCity/est"         
## [10] "/tmp/RtmpUEeCGB/YourCity/images"      
## [11] "/tmp/RtmpUEeCGB/YourCity/network"     
## [12] "/tmp/RtmpUEeCGB/YourCity/post"        
## [13] "/tmp/RtmpUEeCGB/YourCity/post/df"     
## [14] "/tmp/RtmpUEeCGB/YourCity/post/grids"  
## [15] "/tmp/RtmpUEeCGB/YourCity/post/streets"
## [16] "/tmp/RtmpUEeCGB/YourCity/profiles"    
## [17] "/tmp/RtmpUEeCGB/YourCity/veh"
\end{verbatim}
...
\begin{verbatim}
## function(V) x[j,i]
## <bytecode: 0x558360d80c60>
## <environment: 0x558395748690>
\end{verbatim}
...
The resulting emission factors vary for each type of vehicle and
includes several pollutants. If the user wants to use IVE emission
factors in VEIN, he/she would have to add them in each
\texttt{*input.R}, after running \texttt{inventory}.
...
In my case, the files are in directory /tmp/RtmpUEeCGB/YourCity. Now, if
...
\caption{\label{tab:unnamed-chunk-95}Black Carbon and Organic Matter [g/168h]}
\centering
...
\caption{\label{tab:unnamed-chunk-97}Ratio between break and tyre wear emissions}
\centering
\begin{tabular}[t]{l|r}
\hline
  & x\\
...
\begin{figure}
\includegraphics[width=6.81in]{figuras/wrf} \caption{http://www.lapat.iag.usp.br/aerossol/wrf9/index.php}\label{fig:unnamed-chunk-101}
\end{figure}
...
\begin{figure}
\includegraphics[width=12.36in]{figuras/iag1} \caption{Speciation for NMHC by type of fuel and process mol/100g (Ibarra-Espinosa, S., 2017)}\label{fig:unnamed-chunk-102}
\end{figure}
...
\begin{verbatim}
## Units: [mol/h]
## [1] 0.9296673 0.9204110 0.9285217
## Units: [mol/h]
## [1] 1.431566 1.417312 1.429802
## Units: [mol/h]
## [1] 0.5217630 0.5165680 0.5211201
## Units: [mol/h]
## [1] 0.2517638 0.2492571 0.2514536
## Units: [mol/h]
## [1] 1.910220 1.891201 1.907866
## Units: [mol/h]
## [1] 0.8008394 0.7928658 0.7998525
## Units: [mol/h]
## [1] 0.5309289 0.5256426 0.5302746
## Units: [mol/h]
## [1] 0.02546733 0.02521376 0.02543595
## Units: [mol/h]
## [1] 0.4621810 0.4575793 0.4616115
## Units: [mol/h]
## [1] 0.8805297 0.8717626 0.8794446
## Units: [mol/h]
## [1] 1.236844 1.224529 1.235319
## Units: [mol/h]
## [1] 0.3467050 0.3432530 0.3462777
## Units: [mol/h]
## [1] 0.4521764 0.4476743 0.4516192
## Units: [mol/h]
## [1] 0 0 0
## Units: [mol/h]
## [1] 0 0 0
...
\caption{\label{tab:unnamed-chunk-104}Speciation of PM2.5}
\centering
...
\begin{verbatim}
## Sum of street emissions 602045.17
\end{verbatim}
...
\begin{verbatim}
## Sum of gridded emissions 602045.17
\end{verbatim}
...
## 1 0.001450248 [g/m^2/s] 0.01173382 0.0004652094 0.001983261 0.01883439
## 2 0.001441498 [g/m^2/s] 0.01166303 0.0004624025 0.001971295 0.01872075
## 3 0.001477585 [g/m^2/s] 0.01195501 0.0004739786 0.002020646 0.01918942
## 4 0.002544887 [g/m^2/s] 0.02059045 0.0008163468 0.003480215 0.03305048
## 5 0.005774243 [g/m^2/s] 0.04671888 0.0018522573 0.007896465 0.07499017
## 6 0.000000000 [g/m^2/s] 0.00000000 0.0000000000 0.000000000 0.00000000
##     e_pm2.5j      e_orgi     e_orgj      e_eci       e_ecj        h2o
## 1 0.05650316 0.005725654 0.02440937 0.01054726 0.004520253 0.05217126
## 2 0.05616225 0.005691108 0.02426209 0.01048362 0.004492980 0.05185647
## 3 0.05756826 0.005833583 0.02486949 0.01074607 0.004605461 0.05315469
## 4 0.09915143 0.010047345 0.04283342 0.01850827 0.007932115 0.09154982
## 5 0.22497052 0.022797013 0.09718726 0.04199450 0.017997642 0.20772278
...
\begin{verbatim}
## using grid info from: /usr/local/lib/R/site-library/eixport/extdata/wrfinput_d02 
