...
\begin{verbatim}
## files at /tmp/Rtmp3yqgZh/YourCity
\end{verbatim}

\begin{verbatim}
## Directories:
##  [1] "/tmp/Rtmp3yqgZh/YourCity"             
##  [2] "/tmp/Rtmp3yqgZh/YourCity/ef"          
##  [3] "/tmp/Rtmp3yqgZh/YourCity/emi"         
##  [4] "/tmp/Rtmp3yqgZh/YourCity/emi/BUS_01"  
##  [5] "/tmp/Rtmp3yqgZh/YourCity/emi/HGV_01"  
##  [6] "/tmp/Rtmp3yqgZh/YourCity/emi/LCV_01"  
##  [7] "/tmp/Rtmp3yqgZh/YourCity/emi/MC_01"   
##  [8] "/tmp/Rtmp3yqgZh/YourCity/emi/PC_01"   
##  [9] "/tmp/Rtmp3yqgZh/YourCity/est"         
## [10] "/tmp/Rtmp3yqgZh/YourCity/images"      
## [11] "/tmp/Rtmp3yqgZh/YourCity/network"     
## [12] "/tmp/Rtmp3yqgZh/YourCity/post"        
## [13] "/tmp/Rtmp3yqgZh/YourCity/post/df"     
## [14] "/tmp/Rtmp3yqgZh/YourCity/post/grids"  
## [15] "/tmp/Rtmp3yqgZh/YourCity/post/streets"
## [16] "/tmp/Rtmp3yqgZh/YourCity/profiles"    
## [17] "/tmp/Rtmp3yqgZh/YourCity/veh"
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{figuras/gway.png}
\caption{\label{fig:unnamed-chunk-43}Driving route between zones `Luz' and
`Bom Retiro' in São Paulo}
\end{figure}
...
\begin{verbatim}
## Warning in if (!class(ef) %in% c("list", "units", "EmissionFactorsList", :
...
In my case, the files are in directory /tmp/Rtmp3yqgZh/YourCity. Now, if
...
\begin{verbatim}
## Units: [mol/h]
## [1] 0.9195642 0.9247390 0.9257775
## Units: [mol/h]
## [1] 1.416008 1.423977 1.425576
## Units: [mol/h]
## [1] 0.5160928 0.5189971 0.5195799
## Units: [mol/h]
## [1] 0.2490278 0.2504292 0.2507104
## Units: [mol/h]
## [1] 1.889461 1.900094 1.902228
## Units: [mol/h]
## [1] 0.7921363 0.7965940 0.7974886
## Units: [mol/h]
## [1] 0.5251590 0.5281143 0.5287074
## Units: [mol/h]
## [1] 0.02519056 0.02533232 0.02536077
## Units: [mol/h]
## [1] 0.4571583 0.4597309 0.4602472
## Units: [mol/h]
## [1] 0.8709605 0.8758619 0.8768455
## Units: [mol/h]
## [1] 1.223402 1.230287 1.231669
## Units: [mol/h]
## [1] 0.3429372 0.3448670 0.3452543
## Units: [mol/h]
## [1] 0.4472624 0.4497794 0.4502845
## Units: [mol/h]
## [1] 0 0 0
## Units: [mol/h]
## [1] 0 0 0
...
\begin{verbatim}
## Sum of street emissions 602035.34
\end{verbatim}
...
\begin{verbatim}
## Sum of gridded emissions 602035.34
\end{verbatim}
...
## 1 0.001443967 [g/m^2/s] 0.01168300 0.0004631945 0.001974671 0.01875282
## 2 0.001435254 [g/m^2/s] 0.01161251 0.0004603998 0.001962757 0.01863967
## 3 0.001471186 [g/m^2/s] 0.01190323 0.0004719258 0.002011894 0.01910631
## 4 0.002544743 [g/m^2/s] 0.02058929 0.0008163008 0.003480019 0.03304861
## 5 0.005777896 [g/m^2/s] 0.04674843 0.0018534289 0.007901460 0.07503761
## 6 0.000000000 [g/m^2/s] 0.00000000 0.0000000000 0.000000000 0.00000000
##     e_pm2.5j      e_orgi     e_orgj      e_eci       e_ecj        h2o
## 1 0.05625845 0.005700856 0.02430365 0.01050158 0.004500676 0.05194530
## 2 0.05591900 0.005666459 0.02415701 0.01043821 0.004473520 0.05163188
## 3 0.05731892 0.005808318 0.02476178 0.01069953 0.004585514 0.05292447
## 4 0.09914584 0.010046779 0.04283100 0.01850722 0.007931667 0.09154466
## 5 0.22511282 0.022811432 0.09724874 0.04202106 0.018009026 0.20785417
...
\begin{verbatim}
## Number of age is 24708.77 * 10^3 veh
\end{verbatim}
...
\begin{verbatim}
## Number of age is 2809.3 * 10^3 veh
\end{verbatim}
...
\includegraphics{veinbook_files/figure-latex/unnamed-chunk-113-1.pdf}
...
\KeywordTok{wrf_create}\NormalTok{(}\DataTypeTok{wrfinput_dir =} \KeywordTok{system.file}\NormalTok{(}\StringTok{"extdata"}\NormalTok{, }\DataTypeTok{package =} \StringTok{"eixport"}\NormalTok{),}
           ...
           \DataTypeTok{frames_per_auxinput5 =} \DecValTok{1}\NormalTok{,}
...
\begin{verbatim}
## [1] "/tmp/Rtmp3yqgZh/wrfchemi_d02_2011-08-01_00:00:00"
\end{verbatim}
...
\begin{verbatim}
## [1] "ncvar_put: warning: you asked to write 3213 values, but the passed data array has 539784 entries!"
\end{verbatim}
...
version 0.4.6 has all the 2016 emission factors of CETESB, almost 100
